...
require "PHP/IndProductPriceDis.php";
            ...
            <div class="main-summary-description-conatiner">
               <a href='PHP/checkStatusForBasket.php?product=<?php echo"$res["Product_ID"]"; ?>'> <button>Put in the basket <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
