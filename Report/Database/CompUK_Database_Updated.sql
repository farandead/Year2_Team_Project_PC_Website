...
Address_Status ENUM('Accessible','Hidden','Default'),
...
CREATE TABLE CompUK.Linked_Address_and_Order(
Address_ID  int NOT NULL,
FOREIGN KEY (Address_ID) REFERENCES CompUK.Delivery_address(Address_ID),
Order_ID  int NOT NULL,
FOREIGN KEY (Order_ID) REFERENCES CompUK.OrderP(Order_ID)
);
